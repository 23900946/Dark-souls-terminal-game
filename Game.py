    ...
    while demon_health > 0:
        ...
        if choice == "Attack":
            ...
            if dodge == 1:
                ...
                health += 20
                estus_flasks -= 1
                print(f"Estus flasks left: {estus_flasks}")
                print("")
                time.sleep(2)
...
def sens_fortress():
    ...
    print("")
    time.sleep(3)
    print("The gates of the fortress are opened for you by a giant and you proceed to enter the fort.")
    print("")
    time.sleep(3)
